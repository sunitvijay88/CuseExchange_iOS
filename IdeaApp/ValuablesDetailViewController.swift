//
//  ValuablesDetailViewController.swift
//  ValuablesDetail
//
...
class ValuablesDetailViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print ("Inside Valuables \(commaEmail)")
